...
#define SMMIC_IRRIGATION "smmic/sensor/triggers/irrigation/58c6dd67-3200-4bf0-8044-a851465edd02"
#define ALERTS "smmic/sensor/alert"
#define INTERVAL "smmic/sensor/triggers/interval/58c6dd67-3200-4bf0-8044-a851465edd02"
...
void mqttTask(void *pvParameters) {
  ...
  while (true) {
    ...
    int soilMoisturePercentage = map(soilMoistureValue, min_moisture, max_moisture, 100, 0);  // Reverse to show percentage correctly
...
void reconnectMQTT() {
  while (!client.connected()) {
    ...
    if (client.connect("ESP32Client", nullptr, nullptr, lwtTopic, lwtQos, lwtRetain, lwtMessage)) {
